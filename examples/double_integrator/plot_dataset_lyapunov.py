...
class PlotDatasetLyapunovConfig(ArgumentParserConfig):
    """Configuration for plotting the interpolated Lyapunov value function from an MPC dataset."""
...
def parse_args() -> PlotDatasetLyapunovConfig:
    ...
    parser = argparse.ArgumentParser(
        description="Interpolate and plot Lyapunov value function V_N from an MPC dataset using mdg_plt.",
